...
//Variable initialization
   ...
   int z = 5;
    ...
    private void initComponents() {
        ...
        passLP.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                passLPKeyPressed(evt);
            }
        });
...
//Login button   
    ...
    private void userLPKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_userLPKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {   
            passLP.requestFocusInWindow();
        }
    }//GEN-LAST:event_userLPKeyPressed

    private void passLPKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_passLPKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
        
            jButton2.doClick(); 
       
        }
    }//GEN-LAST:event_passLPKeyPressed
